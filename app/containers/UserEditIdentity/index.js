 ...
 * 
 * the page maby just select the service, but also select the industry firstly, the select the service.
 */
...
UserEditIdentity.propTypes = {
  ...
  /**
   * actiobn: get the industry
   */
  getIndustry: PropTypes.func,
  /**
   * action: get the service
   */
